...
def rpn(base_layers, num_anchors,trainable=True):
    ...
    """ RPN architecture Adopted from "Faster R-CNN: Towards Real-Time Object 
        ...
        The number 768 is the output depth of the mixed-6 layer
    
    """

    x = Conv2D(768, (3, 3), padding='same', activation='relu', kernel_initializer='normal', name='rpn_conv1',trainable=trainable)(base_layers)
